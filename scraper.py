...
def parse_html(browser, html):
    ...
    data_listing_id_from_db = database.get_item_ids()
    logger.debug(
    ...
    for item in items:
        ...
        try:
            ...
            if data_listing_id in data_listing_id_from_db:
                ...
                item_description_min = item_description_min.replace('\n',
                                                                    '').strip() + '...'
                logger.debug(f'item_description_min: {item_description_min}')
                ...
                logger.debug(
                    f'item_description_tagline: {item_description_tagline}')
                ...
                item_currency = item_price_str[0]
                ...
                logger.debug(f'item_intersections: {item_intersections}')
