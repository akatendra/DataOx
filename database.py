...
def create_connection():
    ...
    connection = psycopg2.connect(database='dataox',
                                  user='dataox9261',
                                  password='qKkefbQEBL',
                                  host='127.0.0.1',
                                  port='5432'
...
def write_to_db(data):
    ...
    logger.debug(f'counter: {scraper.counter}')
...
def create_dataox_db():
    user_name = 'dataox9261'
    user_password = 'qKkefbQEBL'
    db_name = 'dataox'
    try:
        # Create connection
